...
const ClientSidebar = () => {
  ...
  const showprojects=()=>{
    navigate('/client-projects',{state:{email:email}})
  }
  const showprofile=()=>{
  ...
  return ( 
    <div className="h-[650px] w-[20%]  pl-4 shadow-md shadow-gray-200 bg-[#282828] text-white">
      ...
      <li className='text-[16px] flex flex-col justify-center ml-10 pl-1 gap-4 mt-4 cursor-pointer'>
         <a href='/' className='hover:text-[#802bb1] hover:scale-105 duration-500'><DashboardIcon/><span className='text-md font-normal ml-2'>Dashboard</span></a>
